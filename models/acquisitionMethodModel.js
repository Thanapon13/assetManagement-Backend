module.exports = (sequelize, Sequelize) => {
  const acquisitionMethod = sequelize.define(
    "TBM_ACQUISITION_METHODS",
    {
      ...
      name: { type: Sequelize.STRING(50), allowNull: false,unique: true, field: "name" },
    },
    {
      tableName: "TBM_ACQUISITION_METHODS",
    }
  );
